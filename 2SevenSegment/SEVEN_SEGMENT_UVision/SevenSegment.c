...
int FirstLED[SIZE]={0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F}; 
int SecondLED[SIZE]={0x003F0000, 0x00060000, 0x005B0000, 0x004F0000, 0x00660000, 0x006D0000, 0x007D0000, 0x00070000, 0x007F0000, 0x006F0000}; 
...
int main(void)
{
	...
	IO0DIR = 0x00FF00FF; 			// P0.0 to P0.6 FirstLED and P0.16 to P0.22 SecondLED
	...
	while(1)
	{
			...
			{ 
				...
				for(j=0; j<SIZE; j++)
				{
						IO0PIN = (FirstLED[i] | SecondLED[j]);
						msecdelay(20);
						IO0PIN =  (FirstLED[i] & 0x00FF0000);
				}
